...
$module_constant = 'STAMPS_SHIPRUSH_CONFIG_VERSION'; // This should be a UNIQUE name followed by _VERSION for convention
$module_installer_directory = DIR_FS_ADMIN . 'includes/installers/stamps_shiprush'; // This is the directory your installer is in, usually this is lower case
$module_name = "Stamps ShipRush Configuration"; // This should be a plain English or Other in a user friendly way
$zencart_com_plugin_id = 1950; // from zencart.com plugins - Leave Zero not to check
