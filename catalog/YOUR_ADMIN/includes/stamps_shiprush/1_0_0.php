...
('Stamps Access Token', 'STAMPS_SHIPRUSH_ACCESS_TOKEN', '".shiprush_random_string(31)."', 'To Create a new random SHIPPING_ACCESS_TOKEN  Please take these steps: <br/><ol><li> Go to http://www.pctools.com/guides/password/     (you can use another random password generator if you like)</li><li>Check ALL the boxes EXCEPT the punctuation box</li><li>Set the LENGTH to 31</li></ol>', " . $configuration_group_id . ", 12, NOW(), NOW(), NULL, NULL),
...
('Cancelled Order Status ID', 'STAMPS_SHIPRUSH_CANCELLED_STATUS_ID', 'true', 'Show Footer in checkout?', " . $configuration_group_id . ", 20, NOW(), NOW(), 'zen_get_order_status_name', 'zen_cfg_pull_down_order_statuses(');" );
